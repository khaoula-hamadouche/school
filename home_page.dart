        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                _buildCard('Voir notes', 'assets/note.png', context, NotesPage()),
                _buildCard('Emplois du temps', 'assets/temps.png', context, TempsPage()),
                _buildCard('Voir les absences', 'assets/absence.png', context, AbsencesPage()),
                _buildCard('Voir les cours', 'assets/cours.png', context, CoursPage()),
              ],
            ),
          ],
        ),
